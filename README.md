...
- **Project Scope**: For the selected project, each group will apply concepts from COSC 112. Only include topics covered in the course; avoid using material not discussed in class.

- **Group Formation**:
  - Maximum of Three (3) members per group.
